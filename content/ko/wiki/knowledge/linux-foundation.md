...
status: draft
sources:
  - uri: https://github.com/jyje/blog/blob/34752ed2db6859c9d98f7d197276f4e46549e3a2/content/docs/linux-foundation.md
---
...
- Linux 커널
- [Kubernetes](./k8s.md): 컨테이너 오케스트레이션 플랫폼
- Node.js: 자바스크립트 런타임
- [CNCF](./cncf.md) (Cloud Native Computing Foundation): 클라우드 네이티브 기술 지원
