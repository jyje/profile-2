...
status: draft
sources:
  - uri: https://github.com/jyje/blog/blob/34752ed2db6859c9d98f7d197276f4e46549e3a2/content/docs/istio.md
---
...
## Definition
- 마이크로서비스의 통신을 관리하고 제어하는 [서비스 메시(Service Mesh)](./service-mesh.md) 구현체
...
- 트래픽 모니터링 및 문제 해결
- A/B 테스팅, 카나리 배포
	- [Argo Rollouts](./argo-rollouts.md)와 결합하여 고도화된 테스트 및 롤링 업데이트 가능
